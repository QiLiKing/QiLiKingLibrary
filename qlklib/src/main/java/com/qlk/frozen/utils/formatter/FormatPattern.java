...
public final class FormatPattern {
     ...
     * 数字（包括整数和小数）
     */
    public static final String NumberRegular = "[+,-]?\\d+\\.?\\d*";

    /**
     * 0~∞位小数
     */
    public static final String DecimalRegular = "[+,-]?\\d+\\.?\\d*";

    /**
     * 0~n位小数
     */
    public static final String DigitRegular = "[+,-]?\\d+\\.?\\d{0,%d}";
