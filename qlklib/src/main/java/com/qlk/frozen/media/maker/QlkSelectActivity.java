...
import com.qlk.frozen.FrzSelector;
...
public class QlkSelectActivity extends AppCompatActivity implements ISelectCallback {
    ...
    private int mType;
    private FrzSelector.Mode mMode;
    private FrzSelector<String> mSelector = new FrzSelector<>();
    ...
    public static class Builder {
        ...
        public Builder(Context context, int type, FrzSelector.Mode mode) {
            this.context = context;
            this.type = type;
            this.mode = mode;
        }
        ...
        public Builder setSelectMode(FrzSelector.Mode mode) {
            this.mode = mode;
            return this;
        }
        ...
        public Intent defaultBuild() {
            ...
            intent.putExtra(KEY_SELECT_MODE, FrzSelector.Mode.Single);
            return intent;
        }
    }
}
