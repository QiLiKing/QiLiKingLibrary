...
//            null,
    ...
    public void isFileInvalid() {
        ...
        for (String path : PATHS) {
            System.out.println(path + "---" + FrzFileUtil.isFileInvalid(path));
        }
    }
    ...
    public void getFileName() {
        ...
        for (String path : PATHS) {
            System.out.println(path + "---" + FrzFileUtil.getFileName(path));
        }
    }
    ...
    public void getParentDir() {
        ...
        for (String path : PATHS) {
            System.out.println(path + "---" + FrzFileUtil.getParentDir(path));
        }
    }
    ...
    public void getFolder() {
        ...
        for (String path : PATHS) {
            System.out.println(path + "---" + FrzFileUtil.getFolder(path));
        }
    }
    ...
    public void deleteAllFiles() {
        ...
        file.delete();
        rootFile.delete();
        assertEquals(true, FrzFileUtil.deleteAllFiles(VALID_ROOT));
        ...
        //3. not empty folder
        FrzFileUtil.createFile(VALID_PATH, true);
        assertEquals(true, FrzFileUtil.deleteAllFiles(VALID_ROOT));
        ...
        //4. delete file
        FrzFileUtil.createFile(VALID_PATH, true);
        assertEquals(true, FrzFileUtil.deleteAllFiles(VALID_PATH));
    ...
    public void copyFile() {
        ...
        FrzFileUtil.createDirectory(VALID_ROOT, true);
        FrzFileUtil.write(srcPath, data, true);

        String desPath = FrzFileUtil.needRename(VALID_PATH);
        FrzFileUtil.copyFile(srcPath, desPath);
    ...
    public void needRename() {
        ...
        FrzFileUtil.deleteAllFiles(VALID_ROOT);

        String conflictPath = VALID_ROOT + "/test.txt";   //create
        String expectedPath = VALID_ROOT + "/test.txt";
        assertEquals(expectedPath, FrzFileUtil.needRename(conflictPath, true));
...
//        File file = new File(INVALID_PATH);
        ...
        rootFile.delete();
        file.mkdirs();
        assertEquals(false, FrzFileUtil.createFile(VALID_PATH));
        ...
        rootFile.delete();
        file.mkdirs();
        assertEquals(true, FrzFileUtil.createFile(VALID_PATH, true));
        assertEquals(true, file.exists());
        ...
        file.delete();
        rootFile.delete();
        assertEquals(true, FrzFileUtil.createFile(VALID_PATH));
        assertEquals(true, file.exists());
        assertEquals(true, file.isFile());
        ...
        assertEquals(true, FrzFileUtil.createFile(VALID_ROOT, true));
    ...
    public void createDirectory() {
        ...
        //1. is a file
        FrzFileUtil.createFile(directory, true);
        assertEquals(true, file.isFile());
        FrzFileUtil.createDirectory(directory, false);
        assertEquals(false, file.isDirectory());
        FrzFileUtil.createDirectory(directory, true);
        assertEquals(true, file.isDirectory());

        //2. parent not exists
        FrzFileUtil.deleteAllFiles(parent);
        assertEquals(false, parentFile.exists());
        FrzFileUtil.createDirectory(parent, false);
        assertEquals(true, parentFile.exists());
        FrzFileUtil.deleteAllFiles(parent);
        assertEquals(false, parentFile.exists());
        FrzFileUtil.createDirectory(parent, true);
        assertEquals(true, parentFile.exists());

        //3. parent is a file
        FrzFileUtil.createFile(parent, true);
    ...
    public void write() {
        ...
        //not exists
        FrzFileUtil.deleteAllFiles(VALID_PATH);
        FrzFileUtil.write(VALID_PATH, data);   //100 B
        FrzFileUtil.write(VALID_PATH, data, true); //200 B

        //exists
        FrzFileUtil.write(VALID_PATH, data, true); //300 B
        FrzFileUtil.write(VALID_PATH, data);    //100 B
    }
